...
import createArcade2D from "./arcade_2d.js";

import * as baseErrors from "js-slang/dist/errors/base.js";
import * as rttcErrors from "js-slang/dist/errors/rttcErrors.js";
import * as operators from "js-slang/dist/utils/operators.js";
import * as rttc from "js-slang/dist/utils/rttc.js";
...
const dependencies = {
  ...
  "js-slang/dist/utils/operators": operators,
  "js-slang/dist/utils/rttc": rttc
};
...
function requireModule(name) {
  ...
  if (dependency === undefined) {
    throw new Error(`Arcade2D requested unavailable module: ${name}`);
  }

  return dependency;
}

// Load the arcade_2d functions
const {
  build_game,
  create_audio,
  create_circle,
...
const result = build_game();

console.log("build_game result:", result);

if (!result?.gameConfig) {
  throw new Error(
    "build_game() did not return an object containing gameConfig."
  );
}

result.gameConfig.parent = "phaser-game";

new Phaser.Game(result.gameConfig);